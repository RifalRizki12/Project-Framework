                    ...
                    <div class="col-md-12">
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                <form action="/control/{{$control->id}}/update" method="POST" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                        
                                    <div class="form-group">
                                        <label for="">Nama Depan</label>
                                        <input name="nama_depan" type="text" class="form-control" id="exampleInputEmail1" 
                                        aria-describedby="emailHelp" value="{{$control->nama_depan}}" required>
                                    </div>

                                    <div class="form-group" >
                                        <label for="">Nama Belakang</label>
                                        <input name="nama_belakang" type="text" class="form-control" id="exampleInputEmail1" 
                                        aria-describedby="emailHelp" value="{{$control->nama_belakang}}">
                                    </div>
                                    ...
                                    <div class="form-group" >
                                        ...
                                        <input required name="nohp" type="text" class="form-control" id="exampleInputEmail1" 
                                        aria-describedby="emailHelp" value="{{$control->nohp}}">
                                    </div>
                                    ...
                                    <div class="form-group" >
                                          ...
                                          <select name="jenis_kelamin" class="form-control" id="exampleFormControlSelect1">
                                            <option value="Laki-Laki" @if($control->jenis_kelamin == 'Laki-Laki') selected @endif>Laki-Laki</option>
                                            <option value="Perempuan" @if($control->jenis_kelamin == 'Perempuan') selected @endif>Perempuan</option>
                                          </select>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label for="">Agama</label>
                                          ...
                                          aria-describedby="emailHelp" value="{{$control->agama}}" required>
                                            @if($errors->has('agama'))
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="alamat" class="form-control" id="exampleFormControlTextarea1" rows="3" required>{{$control->alamat}}</textarea>
                                    </div>
                                    ...
                                    <a href="/control" class="btn btn-secondary ">Kembali</a>
                                </form>
                            </div>
                        </div>
                    </div>
